    ...
    >
        ...
        style={
          isDark
            ? {
                ...
                boxShadow:
                  "0 0 0 1px rgba(99,157,255,0.08), 0 24px 64px rgba(0,0,0,0.6)",
              }
            : {
                boxShadow:
      ...
      >
              ...
              <div>
                ...
                {employee && (
                  <p className="text-xs text-gray-500 dark:text-[#7A9CC4] mt-1">
                    ...
                    {currentDayOffTotal} {t("joursConge")}
                  </p>
                )}
              </div>
            </div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-5 py-4 space-y-5 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
          ...
          {/* CARD 1 — Current day-off count (ALWAYS shown) */}
          <div
            style={{
              background: isDark
                ? "rgba(99,157,255,0.08)"
                : "rgba(255,255,255,0.8)",
              border: isDark
                ? "1px solid rgba(99,157,255,0.15)"
          ...
          <div>
            <label className="block text-sm font-medium text-[#111827] dark:text-[#E8EFF8] mb-2">
              ...
              <span className="text-[#6B7280] dark:text-[#7A9CC4] font-normal ml-1">
                ({t("optionnel")})
              </span>
            </label>
