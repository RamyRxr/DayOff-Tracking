...
export default function EmployeeDetailPanel({
  ...
  const periodStartMonth = format(
    new Date(calendarYear, calendarMonth, 20),
    "MMMM",
    { locale },
  );
  const periodEndMonth = format(
    new Date(calendarYear, calendarMonth + 1, 19),
    "MMMM",
    { locale },
  );
          ...
          style={
            isDark
              ? {
                  ...
                  boxShadow:
                    "0 0 0 1px rgba(99,157,255,0.1), 0 32px 80px rgba(0,0,0,0.7)",
                }
              : {
                  boxShadow:
                    "0 0 0 1px rgba(0,0,0,0.08), 0 24px 64px rgba(0,0,0,0.2)",
                }
          }
          ...
          <div className="flex-1 min-h-0 overflow-y-auto px-8 py-6 space-y-6 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent">
              ...
              style={
                isDark
                  ? {
                      ...
                      boxShadow:
                        "0 0 0 1px rgba(99,157,255,0.08), 0 4px 16px rgba(0,0,0,0.4)",
                    }
                  : {}
              }
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div
                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full ${status.bg} mt-3`}
                  >
                    <div
                  ...
                  <div className="flex items-center gap-2 mt-3 flex-wrap">
                    ...
                    {employee.ssn && (
                      ...
                      >
                        <span className="text-xs font-mono text-[#6B7280] dark:text-[#7A9CC4]">
                          NSS: {employee.ssn}
                        </span>
                      </div>
                    )}
                ...
                style={
                  isDark
                    ? {
                        ...
                        border: "1px solid rgba(99,157,255,0.12)",
                        boxShadow:
                          "inset 0 1px 2px rgba(0,0,0,0.4), 0 2px 6px rgba(0,0,0,0.3)",
                      }
                    : {
                        boxShadow:
                          "inset 0 1px 2px rgba(0,0,0,0.04), 0 1px 4px rgba(0,0,0,0.04)",
                      }
                }
              >
              ...
              style={
                isDark
                  ? {
                      ...
                      border: "1px solid rgba(99,157,255,0.12)",
                      boxShadow:
                        "0 0 0 1px rgba(99,157,255,0.08), 0 4px 12px rgba(0,0,0,0.4)",
                    }
                  : {
                      boxShadow:
            ...
            >
              ...
              <div
                ...
                style={{
                  borderTop: isDark
                    ? "0.5px solid rgba(99,157,255,0.12)"
                    : "0.5px solid rgba(0,0,0,0.06)",
                }}
              >
                <div className="flex items-center gap-1.5">
                  <div className="w-2 h-2 rounded-full bg-red-500" />
                  <span className="text-[10px] text-gray-500 dark:text-[#7A9CC4]">
                    {t("congeLegend")}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
